...
|------------------------------|-----------------------------------------------------------------------------|------------------------------------------------------------------------|
| 📘 README.md                 | Descripción general del repositorio, equipo y navegación                   | [README.md](./README.md)                                               |
| 📂 Documentación (doc)       | Introducción, problema y público objetivo del proyecto                     | [index.md](./doc/index.md)                                             |
